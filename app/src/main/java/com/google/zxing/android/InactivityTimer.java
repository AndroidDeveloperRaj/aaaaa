...
/**
 * Finishes an activity_group_adminstor after a period of inactivity if the device is on battery
    ...
    private final class InactivityAsyncTask extends
        ...
        protected Object doInBackground(Object... objects) {
            try {
                ...
                Log.i(TAG, "Finishing activity_group_adminstor due to inactivity");
                activity.finish();
