...
public class AlreadyEndAdapter<T> extends BaseQuickAdapter<T, BaseViewHolder> {
    public AlreadyEndAdapter(int viewId, ArrayList<T> list) {
        super(viewId, list);
    }
    ...
    protected void convert(BaseViewHolder helper, T item) {
        ...
        if (productType.equals("0")) {
            helper.setGone(R.id.tv_contact_seller, true).setGone(R.id.tv_express_fee, true).setText(R.id.tv_express_fee, "(含运费" + mContext.getResources().getString(R.string.money_character) + StringUtil.getPrice(((PendingDeliveryModel.DataBean) item).getDeliveryFee()) + ")");
        } else {
            helper.setGone(R.id.tv_contact_seller, false).setGone(R.id.tv_express_fee, false).setText(R.id.tv_express_fee, "(含运费" + mContext.getResources().getString(R.string.money_character) + StringUtil.getPrice(((PendingDeliveryModel.DataBean) item).getDeliveryFee()) + ")");
        }
        ...
        helper.setText(R.id.tv_shop_name, orderItemListBean.getProductName())//商品名
                ...
                .setText(R.id.tv_product_num, orderItemListBean.getProductNum())//商品购买数量和总金额
                ...
                .setText(R.id.tv_contact_seller, "查看物流");//查看物流
