...
public class PendingDeliveryAdapter<T> extends BaseQuickAdapter<T, BaseViewHolder> {
    public PendingDeliveryAdapter(int viewId, ArrayList<T> list) {
        super(viewId, list);
    }
    ...
    protected void convert(BaseViewHolder helper, T item) {
        ...
        helper.setText(R.id.tv_shop_name, orderItemListBean.getProductName())//商品名
                ...
                .addOnClickListener(R.id.tv_contact_cancle)//取消订单
                .addOnClickListener(R.id.tv_contact_buyer)//联系买家
                .addOnClickListener(R.id.tv_contact_seller)
                .setText(R.id.tv_contact_seller, "确认发货");//确认发货
