...
public class GroupHeaderAdapter extends RecyclerView.Adapter<GroupHeaderAdapter.ViewHolder> {

    private Context context;
    private List<GroupMembersModel> list;
    public GroupHeaderAdapter(Context context , List<GroupMembersModel> list) {
