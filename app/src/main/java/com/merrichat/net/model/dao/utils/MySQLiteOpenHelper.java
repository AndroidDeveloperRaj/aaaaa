...
public class MySQLiteOpenHelper extends DaoMaster.OpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        MigrationHelper.migrate(db, UserModelDao.class, MessageModelDao.class, MessageListModleDao.class, NoticeModelDao.class, DraftDaoModelDao.class, ExpressNotificationModelDao.class);
    }
}
