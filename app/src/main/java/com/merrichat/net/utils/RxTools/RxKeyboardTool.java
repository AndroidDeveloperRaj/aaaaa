...
public class RxKeyboardTool {
     ...
     * 动态隐藏软键盘
     *
     * @param activity activity_group_adminstor
     */
     ...
     * @param ev
     */
    public static void clickBlankArea2HideSoftInput1(Context mContext, View v, MotionEvent ev) {
        Log.i("tips", "U should copy the following code.");
        /*
        @Override
    ...
    private static void hideKeyboard(Context mContext, IBinder token) {
        if (token != null) {
