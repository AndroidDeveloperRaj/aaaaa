package com.merrichat.net.utils.spannable;
...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    private final static int DEFAULT_CLICKABLEA_COLOR_ID = R.color.cccccc;
    /**整个textView的背景色*/
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = MerriApp.getContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = MerriApp.getContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
