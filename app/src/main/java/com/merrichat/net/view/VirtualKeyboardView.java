...
public class VirtualKeyboardView extends RelativeLayout {
    ...
    private MyGridView gridView;    //用GrideView布局键盘，其实并不是真正的键盘，只是模拟键盘的功能
    ...
    public VirtualKeyboardView(Context context, AttributeSet attrs) {
        ...
        gridView = (MyGridView) view.findViewById(R.id.gv_keybord);
    ...
    private void setupView() {
        KeyBoardAdapter keyBoardAdapter = new KeyBoardAdapter(context, R.layout.grid_item_virtual_keyboard, valueList);
