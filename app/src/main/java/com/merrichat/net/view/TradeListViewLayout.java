 ...
 * @author 陈靖
 */
public class TradeListViewLayout extends RelativeLayout {
    ...
    public TradeListViewLayout(Context context) {
        super(context);
        initView(context);
    }

    public TradeListViewLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public TradeListViewLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private class AutoRefreshAndLoadTask extends
        ...
        protected void onPostExecute(String result) {
            ...
            // 刷新操作
            if (mListener != null)
                mListener.onRefresh(TradeListViewLayout.this);
            hide();
        }
...
//		pullView=refreshView.findViewById()
//		pullView = refreshView.findViewById(R.id.pull_to_refresh_image);
    ...
    public interface OnRefreshListener {
         ...
         * 刷新操作
         */
        void onRefresh(TradeListViewLayout pullToRefreshLayout);

        /**
         * 加载操作
         */
        void onLoadMore(TradeListViewLayout pullToRefreshLayout);
    }
