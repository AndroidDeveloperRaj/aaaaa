...
public class SmallVideoView extends SurfaceView implements SmallMediaController.MediaPlayerControl, OrientationDetector.OrientationChangeListener {
    ...
    private SmallMediaController mMediaController;
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(SmallVideoView.class.getName());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            info.setClassName(SmallVideoView.class.getName());
        }
    }
...
//        requestFocus();
    ...
    public void setMediaController(SmallMediaController controller) {
...
//                    }
    ...
    private void enableOrientationDetect() {
        if (mAutoRotation && mOrientationDetector == null) {
            ...
            mOrientationDetector.setOrientationChangeListener(SmallVideoView.this);
...
/*
    ...
    private void switchTitleBar(boolean show) {
        if (mContext instanceof AppCompatActivity) {
            AppCompatActivity activity_group_adminstor = (AppCompatActivity)mContext;
            android.support.v7.app.ActionBar supportActionBar = activity_group_adminstor.getSupportActionBar();
            ...
            Activity activity_group_adminstor = (Activity)mContext;
            if(activity_group_adminstor.getActionBar() != null) {
                if (show) {
                    activity_group_adminstor.getActionBar().show();
                } else {
                    activity_group_adminstor.getActionBar().hide();
                }
            }
        }
    }
