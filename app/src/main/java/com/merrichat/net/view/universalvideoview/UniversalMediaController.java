...
//    private boolean mFullscreenEnabled = false;
    ...
    private RelativeLayout relToast;
    ...
    private void initControllerView(View v, Context context) {
        ...
        mBackButton = v.findViewById(R.id.iv_back);
        relToast = (RelativeLayout) v.findViewById(R.id.rel_toast);
...
//        mBackButton.setVisibility(mIsFullScreen ? View.VISIBLE : View.INVISIBLE);
    ...
    private void doPauseResume() {
        if (mPlayer.isPlaying()) {
            ...
            if (relToast.getVisibility() == VISIBLE) {
                relToast.setVisibility(GONE);
            }
            mPlayer.start();
        }
        updatePausePlay();
