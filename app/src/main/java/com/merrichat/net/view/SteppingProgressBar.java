...
public class SteppingProgressBar extends View {
    ...
    public static final int STATE_DELETE_PREPARE = 2;
    public static final int STATE_DELETE_DONE = 3;
    private int mState = STATE_NORMAL;

    private int MAX_PERCENT = 100;
    private final static int PROGRESS_TEXT_SIZE = 0;
    private final static int PROGRESS_SCALE = 1000;
    private final static int PROGRESS_BACKGROUND_COLOR = Color.parseColor("#2B2938");
    private final static int PROGRESS_PASSED_COLOR = Color.parseColor("#FF3D6F");
    private final static int PROGRESS_STAMP_COLOR = Color.parseColor("#2B2938");
    ...
    private OnDeleteCallbackListener onDeleteCallbackListener = null;
    private OnRecordingCallbackListener onRecordingCallbackListener = null;

    public void setOnDeleteCallbackListener(OnDeleteCallbackListener listener) {
        this.onDeleteCallbackListener = listener;
    }

    public void setOnRecordingCallbackListener(OnRecordingCallbackListener listener) {
        this.onRecordingCallbackListener = listener;
    }
    ...
    public interface OnRecordingCallbackListener {
...
//            }
//        }
        if (onRecordingCallbackListener != null) {
            onRecordingCallbackListener.onRecording(mPercent / PROGRESS_SCALE);
        }
    ...
    public void deleteLastStep() {
        ...
        if (onDeleteCallbackListener != null) {
            onDeleteCallbackListener.deleteDone(this.mPercent);
        }
     ...
     * 确认删除前一段进度
     */
    public void deleteLastStepFast(OnDeleteCallbackListener onDeleteCallbackListener) {
        if (mState != STATE_DELETE_PREPARE) {
            deleteLastStepPrepare();
            return;
        }
