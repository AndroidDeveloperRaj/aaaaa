...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private boolean dividerWidthWrap = false;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        dividerWidthWrap = a.getBoolean(R.styleable.PagerSlidingTabStrip_pstsDividerWidthWrap, dividerWidthWrap);
    ...
    public boolean isDividerWidthWrap() {
        return dividerWidthWrap;
    }

    public void setDividerWidthWrap(boolean dividerWidthWrap) {
        this.dividerWidthWrap = dividerWidthWrap;
    }
