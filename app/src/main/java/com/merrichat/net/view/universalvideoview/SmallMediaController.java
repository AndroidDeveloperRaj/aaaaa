...
public class SmallMediaController extends FrameLayout {
    ...
    private ProgressBar mProgress, pb_mini;
...
//    private boolean mFullscreenEnabled = false;
    ...
    private static final int SHOW_MINI_PROGRESS = 9;
    ...
    public SmallMediaController(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    public SmallMediaController(Context context) {
        super(context);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        View viewRoot = inflater.inflate(R.layout.small_player_controller, this);
        viewRoot.setOnTouchListener(mTouchListener);
        initControllerView(viewRoot, context);
    }


    private void initControllerView(View v, Context context) {
...
//        lp.setMargins(0, ScreenUtils.getStatusHeight(context), 0, 0);
//        mTitleLayout.setLayoutParams(lp);
        ...
        pb_mini = (ProgressBar) v.findViewById(R.id.pb_mini);
    ...
    public void show(int timeout) {//只负责上下两条bar的显示,不负责中央loading,error,playBtn的显示.
        ...
        mHandler.sendEmptyMessage(SHOW_MINI_PROGRESS);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case SHOW_PROGRESS: //2
                    ...
                    break;
                case SHOW_MINI_PROGRESS: //9
                    pos = setProgress();
                    if (!mDragging && mPlayer != null && mPlayer.isPlaying()) {
                        msg = obtainMessage(SHOW_MINI_PROGRESS);
                        sendMessageDelayed(msg, 1000 - (pos % 1000));
                    }
                    break;
                case SHOW_LOADING: //3
                    ...
                    break;
                case SHOW_COMPLETE: //7 播放视频完成之后
                    mProgress.setProgress(1000);
                    pb_mini.setProgress(1000);
