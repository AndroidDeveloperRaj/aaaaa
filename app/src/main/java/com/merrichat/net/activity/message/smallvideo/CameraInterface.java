...
import com.merrichat.net.activity.message.smallvideo.util.AngleUtil;
import com.merrichat.net.activity.message.smallvideo.util.CameraParamUtil;
import com.merrichat.net.activity.message.smallvideo.util.CheckPermission;
import com.merrichat.net.activity.message.smallvideo.util.DeviceUtil;
import com.merrichat.net.activity.message.smallvideo.util.FileUtil;
import com.merrichat.net.activity.message.smallvideo.util.ScreenUtils;
...
public class CameraInterface implements Camera.PreviewCallback {
    ...
    public void setSwitchView(ImageView mFlashLamp) {
        this.mSwitchView = mSwitchView;
        this.mFlashLamp = mFlashLamp;
        if (mSwitchView != null) {
            cameraAngle = CameraParamUtil.getInstance().getCameraDisplayOrientation(mSwitchView.getContext(),
...
//        }
        ...
        videoFileName = "small_video_" + System.currentTimeMillis() + ".mp4";
        if (saveVideoPath.equals("")) {
            saveVideoPath = Environment.getExternalStoragePublicDirectory("") + File.separator + "MerriChat" + File.separator + "message" + File.separator + "video";
        }
