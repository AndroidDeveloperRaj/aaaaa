...
import com.merrichat.net.activity.message.smallvideo.listener.CaptureListener;
...
import com.merrichat.net.activity.message.smallvideo.listener.TypeListener;
import com.merrichat.net.activity.message.smallvideo.state.CameraMachine;
...
import com.merrichat.net.activity.message.smallvideo.view.CameraView;
...
//    private static final String TAG = "JCameraView";
    ...
    private void initView() {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.small_video_camera_view, this);
...
//        });
    ...
    public void onResume() {
        ...
        CameraInterface.getInstance().setSwitchView(mFlashLamp);
