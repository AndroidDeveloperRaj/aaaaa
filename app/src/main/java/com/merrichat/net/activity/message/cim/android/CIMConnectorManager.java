...
import com.merrichat.net.activity.message.cim.exception.NetWorkDisableException;
import com.merrichat.net.activity.message.cim.exception.WriteToClosedSessionException;
import com.merrichat.net.activity.message.cim.filter.ClientMessageCodecFactory;
...
class CIMConnectorManager {
    ...
    private synchronized void syncConnection(final String cimServerHost, final int cimServerPort) {
        try {
            ...
            LogUtil.e("@@@", "******************CIM连接服务器失败  " + cimServerHost + ":" + cimServerPort);
    ...
    public void deliverIsConnected() {
        ...
        LogUtil.e("@@@", "******************CIM与服务器连接状态:" + isConnected());
        Intent intent = new Intent();
    ...
    IoHandlerAdapter iohandler = new IoHandlerAdapter() {
        ...
        public void sessionCreated(IoSession session) throws Exception {
            ...
            LogUtil.e("@@@", "******************CIM连接服务器成功:" + session.getLocalAddress());
        ...
        public void sessionClosed(IoSession session) throws Exception {
            ...
            LogUtil.e("@@@", "******************CIM与服务器断开连接:" + session.getLocalAddress());
        ...
        public void sessionIdle(IoSession session, IdleStatus status)
                throws Exception {
            LogUtil.e("@@@", "******************CIM与服务器连接空闲:" + session.getLocalAddress());
        ...
        public void messageReceived(IoSession session, Object obj)
            ...
            LogUtil.e("@@@", "CIMConnectorManager收到服务器消息" + obj.toString());
