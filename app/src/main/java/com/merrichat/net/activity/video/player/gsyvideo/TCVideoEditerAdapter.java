...
public class TCVideoEditerAdapter extends RecyclerView.Adapter<TCVideoEditerAdapter.ViewHolder> {
    ...
    public static final int THUMB_COUNT = 10;//图片数量
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final int itemCount = THUMB_COUNT;
        int padding = mContext.getResources().getDimensionPixelOffset(R.dimen.fab_margin);
