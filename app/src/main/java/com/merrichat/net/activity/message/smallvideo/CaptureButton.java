...
import static com.merrichat.net.activity.message.smallvideo.JCameraView.BUTTON_STATE_BOTH;
import static com.merrichat.net.activity.message.smallvideo.JCameraView.BUTTON_STATE_ONLY_CAPTURE;
import static com.merrichat.net.activity.message.smallvideo.JCameraView.BUTTON_STATE_ONLY_RECORDER;
