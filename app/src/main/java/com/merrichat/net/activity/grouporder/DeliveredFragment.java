...
import com.merrichat.net.adapter.DeliveredAdapter;
...
public class DeliveredFragment extends BaseFragment implements BaseQuickAdapter.OnItemChildClickListener, OnRefreshListener, OnLoadmoreListener {
    private final int orderStatus = 3;//订单状态,0待成团,1未付款,2待发货,3送货中/（待收货）,4已收货 ,5已取消,6拒收,7退款 8仲裁
    ...
    private void initView() {
        ...
        deliveredAdapter = new DeliveredAdapter(R.layout.item_pending_delivery, pendingDeliveryList);

        rlRecyclerview.setAdapter(deliveredAdapter);
        deliveredAdapter.setOnItemChildClickListener(this);
    ...
    public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        switch (view.getId()) {
            case R.id.tv_contact_cancle://查看物流
            ...
            case R.id.ll_product_info://详情
                ...
                bundle1.putString("serialNumber", dataBean.getOrderId());
                bundle1.putString("fragmentId", "已发货");
