...
public class ModifyGroupLocationsActivity extends MerriActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modify_group_locations);
     ...
     * 修改群地址
     */
    private void updateGroupOfAddress() {
        OkGo.<String>post(Urls.updateGroupOfAddress)
                .params("cid", groupId)
                .params("memberId", UserModel.getUserModel().getMemberId())
                .params("address", locationModel.address)
                .params("longitude", locationModel.currentLongitude)
                .params("latitude", locationModel.currentLatitude)
