...
public class ShareToMakeMoneyAty extends BaseActivity implements BaseQuickAdapter.OnItemChildClickListener {
...
//        shareToMakeMoneyAdapter.addHeaderView(getHeaderView(), -1, LinearLayout.VERTICAL);
                            ...
                            try {
                                ...
                                if (jsonObjectEx.optBoolean("success")) {
                                    ...
                                    if (shareToMakeMoneyModel.isSuccess()) {
                                        ...
                                        String h5Url = dataBeanX.getH5Url();
                                        Glide.with(ShareToMakeMoneyAty.this).load(h5Url).into(ivAdHeader);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.iv_ad_header://赚钱攻略
                RxActivityTool.skipActivity(ShareToMakeMoneyAty.this, ShareToMakeMoneyStrategyAty.class);
                break;
        }
    }
    ...
    private void addGoodFriends(final int position) {
        OkGo.<String>post(Urls.addGoodFriends)
                ...
                .params("source", "0")
                .execute(new StringDialogCallback(ShareToMakeMoneyAty.this) {
                    @Override
                    public void onSuccess(Response<String> response) {
                        try {
