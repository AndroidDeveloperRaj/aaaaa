...
public class STSGetter extends OSSFederationCredentialProvider {
    ...
    public OSSFederationToken getFederationToken() {
        ...
        try {
            ...
            JSONObject data = jsonObjs.optJSONObject("data");
            String ak = data.optString("AccessKeyId");
            String sk = data.optString("AccessKeySecret");
            String token = data.optString("SecurityToken");
            String expiration = data.optString("Expiration");
