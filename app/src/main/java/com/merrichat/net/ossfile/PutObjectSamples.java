...
public class PutObjectSamples extends BaseSamples {
    ...
    public PutObjectSamples(Context context, String testBucket, String testObject, String uploadFilePath) {
        ...
        this.oss = new OSSClient(mContext, Config.endpoint, credentialProvider, conf);
