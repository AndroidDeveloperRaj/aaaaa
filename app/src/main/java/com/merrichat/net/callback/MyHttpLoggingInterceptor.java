...
public class MyHttpLoggingInterceptor implements Interceptor {
    ...
    private volatile MyHttpLoggingInterceptor.Level printLevel = MyHttpLoggingInterceptor.Level.NONE;
    ...
    public void setPrintLevel(MyHttpLoggingInterceptor.Level level) {
        if (printLevel == null)
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (printLevel == MyHttpLoggingInterceptor.Level.NONE) {
    ...
    private void logForRequest(Request request, Connection connection) throws IOException {
        boolean logBody = (printLevel == MyHttpLoggingInterceptor.Level.BODY);
        boolean logHeaders = (printLevel == MyHttpLoggingInterceptor.Level.BODY || printLevel == MyHttpLoggingInterceptor.Level.HEADERS);
