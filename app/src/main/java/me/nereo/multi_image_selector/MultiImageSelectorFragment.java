...
public class MultiImageSelectorFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.mis_fragment_multi_images, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mYulan = (Button) view.findViewById(R.id.btn);
        mYulan .setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (resultList != null && resultList.size() > 0) {
                    Intent intent = new Intent();
                    intent.setClassName(getActivity().getPackageName(), "com.merrichat.net.activity.message.camera.PhotopreviewActivity");
                    intent.putExtra("imgUrls", resultList);//通过意图传递数据
                    startActivity(intent);//跳转到另一个Activity
                } else {
                    Toast.makeText(getContext(),"请选择预览图片！",LENGTH_SHORT).show();
                }
            }
        });
            ...
            if (resultCode == Activity.RESULT_OK) {
                if (mTmpFile != null) {
                    if (mCallback != null) {
                        ...
                        Image image = new Image(absolutePath, mTmpFile.getName(), 100299230);
        ...
        if (ContextCompat.checkSelfPermission(getContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                ...
                if (mTmpFile != null && mTmpFile.exists()) {
                    ...
                    Toast.makeText(getActivity(), R.string.mis_error_image_not_exist, LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(getActivity(), R.string.mis_msg_no_camera, LENGTH_SHORT).show();
            }
        }
    }
            ...
            if (mode == MODE_MULTI) {
                if (resultList.contains(image.path)) {
                    ...
                    if (selectImageCount() == resultList.size()) {
                        Toast.makeText(getActivity(), R.string.mis_msg_amount_limit, LENGTH_SHORT).show();
                        return;
                    }
    ...
    /**
     * Callback for host activity_group_adminstor
     */
